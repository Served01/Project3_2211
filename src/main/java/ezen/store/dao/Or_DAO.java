...
//	}
	...
	public List<Or_Bean> OrUpdate(@Param("or_mbid") String or_mbid, @Param("or_number") String or_number, @Param("or_status") String or_status){
		return or_Mapper.OrUpdate(or_mbid, or_number);
	}
	//내역 정보 수정
