...
public interface BoardMapper {
	...
	@Select("select c.content_idx, c.content_subject, u.mb_name as content_writer_name, " +
			 "to_char(c.content_date, 'YYYY-MM-DD') as content_date " +
			 "from content_table c, mb_info u " +
