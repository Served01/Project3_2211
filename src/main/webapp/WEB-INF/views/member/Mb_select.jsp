...
<div class="container" align="center">
	<div class="input-form col-md-12 mx-auto">	
        <a href="#" onclick="location.href='index.jsp'"><h2><i class="fa-solid fa-book"></i>Ezen Book Store</h2></a>  
        <br>
        <h4 class="mb-3">회원 정보 보기 화면 - 마이 페이지</h4>
          ...
          <div class="mb-4"></div>
          <button class="btn btn-dark" onclick="location.href='Mbupdate?mb_id=${mbBean.mb_id}'">수정</button>
          <button class="btn btn-dark" onclick="location.href='Mbdelete?mb_id=${mbBean.mb_id}'">삭제</button>
          <a href="${root }index" class="btn btn-danger">메인화면</a>
                    
</div>
</div>
		<c:import url="/delivery/DvList">
		<c:param name="Deliverylist" value="${mb_id}"/>
		<c:param name="Deliverylist" value="${dv_nick}"/>						
		</c:import>	
