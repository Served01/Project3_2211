...
<body>
	...
	<form:form action="${root }review/insert_pro" method="post" modelAttribute="insertRvBean">
		...
		<!-- 기능 확인을 위한 임시 줄 -->  
			<div>
				...
				<form:input path="rv_id"></form:input>
			...
			<div>
				...
				<form:textarea path="rv_content" rows="10" style="resize:none"></form:textarea>
