...
<div id="lulu" class="jumbotron" style="padding-top:30px; padding-bottom: 30px;">
		<div class="container">
			...
			<h1 style="text-align:center"id="suo" class="display-5">주문번호는 xxxxxxxxx입니다.</h1>
				<div>
				<div class="ae1" style="padding-top:20px">
		<button type="button" class="btn btn-success btn-lg" onclick="location.href='/login'">주문내역</button>
