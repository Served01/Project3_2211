...
<aside class="aside_wrap"style="width:300px;">
	...
	<div class="container">
		...
		<div class="content_inner"></div>
			...
			<div class="col-md-2" style="padding-top: 70px; width:230px">
				...
				<a href='${root}book/BkDeletePro?bk_number=${bl.bk_number}' class="btn btn-secondary" role="button" style="margin-top:10px;">삭제 &raquo;</a>	
			</div>
		</div>
		</div>
		<hr>
