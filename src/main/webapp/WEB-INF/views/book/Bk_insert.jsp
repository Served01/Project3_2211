  ...
  <div class="container">
    <div class="input-form-backgroud row">
      <div class="input-form col-md-12 mx-auto">
        ...
        <form:form class="validation-form" action="book/Bk_insertPro" method="post" modelAttribute="insert_bk_Bean" enctype="multipart/form-data">
          <div class="row">
            <div class="col-md-6 mb-3">
              <form:label path="bk_number">책 일련번호</form:label>
              <form:input type="number" class="form-control" path="bk_number" placeholder="xxxxxxxx"/>
            ...
            <div class="col-md-6 mb-3">
              ...
              <form:input type="text" class="form-control" path="bk_title"/>
              <div class="invalid-feedback">
                책의 제목을 입력해 주세요.
              </div>
            </div>
          ...
          <div class="mb-3">
              ...
              <form:input type="text" class="form-control" path="bk_writer"/>
              <div class="invalid-feedback">
                책의 저자를 입력해 주세요
            </div>
            </div>
            ...
            <div class="mb-3">
              ...
              <form:input type="text" class="form-control" path="bk_publisher"/>
              <div class="invalid-feedback">
                책 출판사를 입력해 주세요
            </div>
            </div>
             ...
             <div class="mb-3">
              ...
              <form:input type="text" class="form-control" path="bk_pubdate"/>
              <div class="invalid-feedback">
                책 출간일을 입력해 주세요
            </div>
            </div>
         ...
         <div class="mb-3">
              ...
              <form:input type="file" class="form-control" path="bk_image" accept="image/*"/>
              <div class="invalid-feedback">
                책 이미지를 선택해주세요
              </div>
         </div>      
           ...
           <div class="mb-3">
             ...
             <div class="mb-3">
              ...
              <form:input type="number" class="form-control" path="bk_quantity"/> 개
              <div class="invalid-feedback">
                책의 재고를 입력해 주세요.            
              </div>
             </div>
             ...
             <div class="mb-3">
              ...
              <form:input type="number" class="form-control" path="bk_price"/> 원
              <div class="invalid-feedback">
                책의 가격을 입력해 주세요.
            </div>
          ...
          <form:button class="btn btn-primary btn-lg btn-block" href="javascript:window.history.back();">뒤로 가기</form:button>
        </form:form>
      </div>
    </div>
