    ...
    <nav class="navbar navbar-light">
        <div class="container-fluid">
          ...
          <form class="d-flex">
            ...
            <button style="height:50px;"class="btn btn-outline-success" type="submit">검색</button></form>
          	 <div class="btn-group" role="group" aria-label="Basic example">
          		
				<!-- 로그인/아웃 상태 구분해서 화면 출력 -->
				<c:choose>
				...
				<c:otherwise>
					...
					<button onclick="location.href='${root }member/Mbinsert'" type="button" class="btn btn-danger">회원가입</button>
				</c:otherwise>
				</c:choose>
