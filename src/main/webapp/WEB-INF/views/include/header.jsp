    ...
    <nav class="navbar navbar-light bg-light">
        <div class="container-fluid">
          ...
          <div class="btn-group" role="group" aria-label="Basic example">
				...
				<a href="${root }member/Mblist?mb_id=admin" class="btn btn-warning">전체회원목록</a>
				<a href="${root }member/Mbselect?mb_id=admin" class="btn btn-success">마이페이지</a> 
				<a href="${root }member/Mbupdate?mb_id=admin" class="btn btn-info">정보수정</a>
				<a href="${root }member/Mbdelete?mb_id=admin" class="btn btn-danger">삭제</a>
				<a href="${root }member/Mblogin" class="btn btn-primary">로그인</a>
				<a href="${root }member/Mblogout" class="btn btn-primary">로그아웃</a>
